...
### 双击没反应？Windows 大概率拦了一下

安装包没有代码签名，从浏览器下载的文件会被打上「来自互联网」的标记，双击时可能弹一个蓝色的框
「**Windows 已保护你的电脑**」。

点框里的 **「更多信息」**，再点底下的 **「仍要运行」** 就行，只需要放行这一次。也可以在安装包上
右键 →「属性」→ 勾上最下面的「解除锁定」→ 确定。

这不是这个项目独有的问题，任何没买代码签名证书的免费软件都会遇到。
